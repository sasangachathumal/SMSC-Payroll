 ...
 * @author smsc
 */
public class SearchbleCombo {
     private ArrayList<String> ar;
    private JTextField txt;

    public SearchbleCombo() {
    }
    /*
    This Method can create Searchble combo. 
    para--- JCombobox,Boolean(true or false),String(if No result what want show)
    */
